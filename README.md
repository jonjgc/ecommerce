...
3.  Para testar as funcionalidades de administrador (como gerenciar produtos), use o login de usuário administrador gerado pelo seed feito no passo 6 na configuração do backend.